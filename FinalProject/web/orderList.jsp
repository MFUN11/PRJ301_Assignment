                                ...
                                <c:forEach items="${requestScope.list}" var="c">
                                   <tr >
                                    ...
                                    <td>${c.cname}</td>
                                     <td>${c.address}</td>
                                    <td>${c.phone}</td>
                                     <td ><fmt:formatNumber pattern="###,###" value="${c.getTotal()}"/></td>
                                    <td class="actions-cell">
                                        <div class="buttons right nowrap">
                                            <button class="button small green --jb-modal"  data-target="sample-modal-2" type="button">
                                                <span class="icon"><a href="dlist?oid=${c.getoID()}" class="mdi mdi-eye"></a></span>
                                            </button>
                                            <button class="button small red --jb-modal" data-target="sample-modal" type="button">
                                                <span class="icon"><i href="#" onclick="doDelete('${c.getoID()}')"class="mdi mdi-trash-can"></i></span>
                                            </button>
                                        </div>
                                    </td>
                                </tr> 
