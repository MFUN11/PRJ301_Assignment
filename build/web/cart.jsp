                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="quantity">
                                                <div class="input-group mb-3">
                                                    <button class="product-remove"><a href="process?num=-1&id=${t.product.getPID()}">-</a></button>
                                                    <input type="number" readonly name="quantity" class="quantity form-control input-number" value="${t.quantity}" min="1" max="100">
